...
export function AdminUsersPanel() {
  ...
  async function handleSubmit(
    payload: AdminUserCreateInput | AdminUserUpdateInput,
  ) {
    if (editingUser) {
    ...
    <section className="space-y-6">
      ...
      {pendingBackend && (
        <div className="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-700">
          La vista ya está integrada, pero el backend aún no expone /admin/users.
        </div>
      )}
                    ...
                    <td className="px-8 py-5">
                      <div className="flex items-center justify-end gap-2">
                        <button
                          ...
                          disabled={submitting || pendingBackend}
                        ...
                        <button
                          ...
                          disabled={submitting || pendingBackend}
                          className="inline-flex items-center gap-1 rounded-lg border border-neutral-200 px-2 py-1 text-[11px] font-semibold text-neutral-600 hover:bg-neutral-100 disabled:opacity-50"
                        >
